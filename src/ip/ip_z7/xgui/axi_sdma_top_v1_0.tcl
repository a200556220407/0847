...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "C_CMD" -parent ${Page_0}
  ipgui::add_param $IPINST -name "C_HW_DB" -parent ${Page_0}
  ...
  ipgui::add_param $IPINST -name "C_TIME_LIMIT" -parent ${Page_0}


}

proc update_PARAM_VALUE.C_CMD { PARAM_VALUE.C_CMD } {
	# Procedure called to update C_CMD when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.C_CMD { PARAM_VALUE.C_CMD } {
	# Procedure called to validate C_CMD
	return true
}

proc update_PARAM_VALUE.C_HW_DB { PARAM_VALUE.C_HW_DB } {
	# Procedure called to update C_HW_DB when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.C_HW_DB { PARAM_VALUE.C_HW_DB } {
	# Procedure called to validate C_HW_DB
	return true
}
...
proc update_PARAM_VALUE.C_TIME_LIMIT { PARAM_VALUE.C_TIME_LIMIT } {
	# Procedure called to update C_TIME_LIMIT when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.C_TIME_LIMIT { PARAM_VALUE.C_TIME_LIMIT } {
	# Procedure called to validate C_TIME_LIMIT
	return true
}
...
proc update_MODELPARAM_VALUE.C_TIME_LIMIT { MODELPARAM_VALUE.C_TIME_LIMIT PARAM_VALUE.C_TIME_LIMIT } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.C_TIME_LIMIT}] ${MODELPARAM_VALUE.C_TIME_LIMIT}
}

proc update_MODELPARAM_VALUE.C_CMD { MODELPARAM_VALUE.C_CMD PARAM_VALUE.C_CMD } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.C_CMD}] ${MODELPARAM_VALUE.C_CMD}
}

proc update_MODELPARAM_VALUE.C_HW_DB { MODELPARAM_VALUE.C_HW_DB PARAM_VALUE.C_HW_DB } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.C_HW_DB}] ${MODELPARAM_VALUE.C_HW_DB}
}
